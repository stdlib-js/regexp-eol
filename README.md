...
```javascript
import reEOL from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-eol@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { REGEXP, REGEXP_CAPTURE } from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp-eol@v0.1.0-deno/mod.js';
```
